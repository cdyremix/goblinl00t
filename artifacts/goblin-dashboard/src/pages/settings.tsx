      ...
      <section className="space-y-4 max-w-2xl">
        ...
        <div className="space-y-2">
          {announcementsLoading ? (
            ...
            <p className="text-sm text-muted-foreground py-2">No announcements yet — add one below.</p>
          ) : (
            (announcements ?? []).map((ann) => (
              <div key={ann.id} className="flex items-center gap-3 rounded-lg border border-border/50 bg-card p-3">
